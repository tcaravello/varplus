...
varexo em ea eb eg eqs epinf ew;  
...
r =  crpi*(1-crr)*pinf+cry*(1-crr)*(y-yf)+crdy*(1-crr)*(y-yf-y(-1)+yf(-1))+crr*r(-1)+ms;
...
stoch_simul(order=1,periods=5000,irf=0);
%stoch_simul(order=1,irf=500,nograph);